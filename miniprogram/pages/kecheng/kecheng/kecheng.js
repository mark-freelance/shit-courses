...
import {collLessons} from "../../../utils/markshawn/lesson";
...
Page({
	...
	loadkecheng: async function (mid) {
		wx.showLoading({title: "加载中",})
		const {data: kechengs} = await collLessons.where({mid}).get()
		console.log('loaded lessons: ', kechengs)
		this.setData({kechengs})
		wx.hideLoading()
	},
